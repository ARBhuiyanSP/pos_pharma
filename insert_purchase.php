...
session_start();
	...
	if(isset($_POST['submit']))
		...
		$select_query 	= mysqli_query($con,$select_sql);
			...
			$insert_sql ="INSERT INTO purchase_details values('','$invoice_number','$medicine_name','$category','$expire_date','$qty','$sell_type','$cost','$amount','$profit_amt','$date')";//*****INSERTING INTO on_HOLD TABLE*******
